...
_CHECKOUT_CMDS = {
    "store_customizations.api.place_order",
    "store_customizations.api.process_payment",
    "store_customizations.api.update_payment_status",
    "store_customizations.api.get_order_status",
}
