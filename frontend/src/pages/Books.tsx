...
const Books: React.FC = () => {
    ...
    const subcategories = ['All', 'Fiction', 'Non-Fiction', 'Academic'];

    const filteredProducts = (() => {
        // Start with all Books category products from central data
        let products = allProducts.filter(p => p.category === 'Books');
        ...
        <div className="product-listing-page">
            <div className="listing-container container">
                <div className="page-header fade-in">
                    <h1>Curated <span>Library</span></h1>
                    <p>Expand your horizon with our collection of masterworks</p>
                </div>
