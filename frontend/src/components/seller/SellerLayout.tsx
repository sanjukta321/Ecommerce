      ...
      <div className="seller-layout">
        ...
        <aside className={`seller-sidebar ${sidebarOpen ? 'open' : ''}`}>
          <div className="seller-sidebar-logo">
            <div className="seller-sidebar-logo-icon">
            ...
            <div>
              <div className="seller-sidebar-logo-text">SB Seller</div>
              <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.35)', letterSpacing: '1px', textTransform: 'uppercase' }}>Portal</div>
            </div>
          </div>
